...
class Anime(models.Model):
    ...
    def average_season(self):
        ...
        return self.season_anime.aggregate(models.Sum('season'))

    @property
    def average_review(self):
        if hasattr(self, '_average_review'):
            return self._average_review
        return self.season_anime.aggregate(models.Sum('review'))
...
class AnimeSeason(models.Model):
    ...
    def average_episode(self):
        ...
        return self.episode_season.aggregate(models.Sum('episode'))
